  ...
  return (
    <div className='bodi-niat mt-[3rem]'>
      <div className="flex flex-col justify-center items-center max-[414px]:mt-[5rem]">
        <div className="flex flex-col items-center mb-3">
          <Link href="/" className="flex justify-start w-full">
            <div>
              <p className="bg-[#0d1811] border border-[#3e664e] hover:bg-[#1e3828] text-white py-1 px-3 rounded-full max-[414px]:text-[12px]">
                ⬅ Back to Home
              </p>
            </div>
          </Link>
      ...
      "
        ...
        <div className="flex flex-col space-y-5 mb-5 w-[50%] max-[414px]:w-[75%]">
        ...
        <div className="flex justify-between w-[50%] max-[414px]:w-[75%]">
          <Link href="/tadarus">
            <div className="bg-[#0d1811] border border-[#3e664e] py-3 px-4 hover:border-[#2b4733] transition-colors active-shadow rounded-full max-[414px]:text-[13px] max-[360px]:text-[10px]">
              Awas Lupa Tadarus
            </div>
          </Link>
          <Link href="/resep">
